 ...
 * @returns {Promise}
 */
export const raw = (tasks, maxInProgress = DEFAULT_MAX, failFast = false, progressCallback, nextCheck = defaultNextTaskCheck) => {
 ...
 */
export const sync = (tasks, failFast = true, progressCallback, nextCheck = defaultNextTaskCheck) =>
	new Promise((resolve, reject) =>
 ...
 * @param failFast optional boolean if we directly reject on a single error defaults to true
 * @param progressCallback optional function to be run to get status updatesupdates
 * @param nextCheck function which should return a promise, when resolved the next task will spawn
 */
export const all = (tasks, maxInProgress = DEFAULT_MAX, failFast = true, progressCallback, nextCheck = defaultNextTaskCheck) =>
	new Promise((resolve, reject) =>
